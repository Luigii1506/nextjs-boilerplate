/**
 * 📦 SHARED TAB COMPONENTS BARREL EXPORT
 * =======================================
 *
 * Exporta todos los componentes reutilizables para tabs
 * Usados en: users, inventory, suppliers, files, etc.
 *
 * Created: 2025-01-27
 */

export { TabHeader, type TabHeaderProps, type TabHeaderAction } from "./TabHeader";
