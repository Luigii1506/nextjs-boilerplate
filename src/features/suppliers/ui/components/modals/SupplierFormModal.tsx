...
type SupplierFormData = Omit<CreateSupplierInput, "rating"> & {
  ...
  rating?: number | null | undefined; // Allow null for form state
};
...
export const SupplierFormModal: React.FC = () => {
  ...
  const {
    ...
    // @ts-expect-error - Schema type varies between create/update modes
  ...
  const watchedRating = watch("rating") ?? null;
  ...
  function getDefaultValues(
    ...
    return {
      id: supplier.id, // ✅ Required for edit mode
      name: supplier.name || "",
      ...
      // Ensure country is always a valid 2-letter code
      country:
        supplier.country && supplier.country.length === 2
        ...
        <BaseModalActions align="between">
          ...
          <div className="flex items-center gap-3">
            ...
            <BaseModalButton
              ...
              onClick={() => {
                // @ts-expect-error - handleSubmit has correct types at runtime
